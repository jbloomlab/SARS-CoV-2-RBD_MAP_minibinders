...
```
    ...
    Plotting correlations of mutation escape for IPD_ligands
...
![png](make_supp_data_files/make_supp_data_16_1.png)
    ...
    Saving plot to results/supp_data/IPD_ligands-mutation-corr.pdf
    
    Plotting correlations of site escape for IPD_ligands
...
![png](make_supp_data_files/make_supp_data_16_3.png)
    ...
    Saving plot to results/supp_data/IPD_ligands-site-corr.pdf
...
```
    ...
    Raw data for IPD_ligands:
    Writing to results/supp_data/IPD_ligands_raw_data.csv
...
```
    ...
    Writing `dms-view` input file for IPD_ligands mapped to PDB 6m0j to results/supp_data/IPD_ligands_6m0j_dms-view_data.csv
